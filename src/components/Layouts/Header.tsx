                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">FourWeb CRM</span>
                        </Link>
                    </div>
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="dropdown shrink-0"> {/*Botão Notificação*/}
                            <Dropdown
                                offset={[0, 8]}
                        ...
                        <div className="dropdown shrink-0 flex"> {/*Botão com a foto*/}
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                ...
                <ul className="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white-dark text-base">
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink to="/dashboard/">{t('Inicial')}</NavLink>
                            </li>
                            <li>
                                <NavLink to="/dashboard/vendas">{t('Vendas')}</NavLink>
                            </li>
                            <li>
                                <NavLink to="/dashboard/prospec">{t('Prospecção')}</NavLink>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink to="/relatorio/vendas">{t('Vendas')}</NavLink>
                            </li>
                            <li>
                                <NavLink to="/relatorio/negociacoes">{t('Negociações')}</NavLink>
                            </li>
                            <li>
                                <NavLink to="/relatorio/empresas">{t('Empresas')}</NavLink>
                            </li>
                        </ul>
                    </li>
